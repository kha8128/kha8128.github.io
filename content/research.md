...
Nanoporous TiO₂ exhibits unique proton transfer properties, critical for applications such as photocatalysis and energy storage. By leveraging <b>machine learning potentials</b>, we explore the confinement effects on proton transfer within these materials. This allows us to better understand and predict proton behavior within the nanoporous environment, optimizing TiO₂-based systems for improved performance.
...
<div style="display: flex; flex-direction: row; justify-content: space-between;">
    <img src="/images/images_large_ez2c00530_0005.jpeg" alt="PFAS Research Figure" style="width: 10%; height: auto;"/>
